...
#########################
CDNF="https://raw.githubusercontent.com/botak8/vvip/main"
###
BURIQ () {
...
wget https://raw.githubusercontent.com/botak8/VVIP/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
...
sleep 2
wget https://raw.githubusercontent.com/botak8/VVIP/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
